function start() {
  ...
  let podeAtirar = true;
  let TECLA = {
    //Teclas com valores decimais
    //Obs.: Verificar outras teclas para as mesmas funções
    W: 87,
    S: 83,
    D: 68,
  };
  ...
  //Verificando se o user pressionou alguma das teclas
  ...
  //Função que realiza a movimentação de fundo do jogo
  function movefundo() {
  ...
  function disparo() {
    if (podeAtirar == true) {
      ...
      //Impede um novo tiro enquanto a função não se encerra
      podeAtirar = false;
  ...
  function colisao() {
    ...
    //Som do carro ao bater no soldado
  ...
  //Reposicionando soldado amigo a cada 6seg
  ...
  //Barra de vida durante a partida
  function energia() {
    if (energiaAtual == 3) {
